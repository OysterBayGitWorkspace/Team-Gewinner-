...
Runway is aged to today before any rule reads it: "3 months as of April" is 0 months in September. Readings up to one month old are taken as they are. The roll-up path reads by health: a STRONG company is the acquirer, a WEAK company joins a platform. A STRONG company on WATCH gets "No action required. Best open option: ...".
